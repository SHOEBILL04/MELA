...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    <div class="mb-8 bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-500">Full history of your stall bookings and payments.</p>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="p-12 text-center text-slate-400 italic">No stalls purchased yet.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
